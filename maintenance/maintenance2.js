...
export const maintenance2Questions = [
    ...
    {
        question: "유압식 제동장치에서 제동력이 떨어지는 원인으로 가장 거리가 먼 것은?",
        options: ["브레이크 오일 압력의 누설", "패드 및 라이닝에 이물질 부착", "유압장치에 공기 유입", "기관 출력 저하"],
        answer: 3,
        explain: "제동력과 기관 출력과는 무관하다."
    },
    {
        question: "자동차 발진 시 마찰클러치의 떨림 현상으로 적합하지 않는 것은?",
        options: ["주축의 스플라인에서 디스크가 축방향으로 이동이 자유롭지 못할 때", "클러치 유격이 너무 클 경우", "디스크 페이싱 마모가 균일하지 못할 때", "디스크 페이싱의 오염 및 유지(오일 또는 그리스) 부착"],
        answer: 0,
        explain: "발진 시 클러치의 떨림 원인\n• 디스크 페이싱의 마모가 불균일한 경우\n• 페이싱에 유지가 부착되어 있거나, 비틀림 코일스프링이 절손되었거나, 디스크가 휘었을 경우\n• 클러치 설치상태에서 릴리스레버(또는 다이어프램)의 높이가 불균일할 경우\n• 릴리스-베어링의 파손 또는 접촉면이 경사되어 있을 경우"
    },
    {
        question: "엔진 냉각장치의 누설 점검 시 누설 부위로 틀린 것은?",
        options: ["워터펌프 개스킷의 누설", "라디에이터의 누설", "수온조절기 개스킷의 누설", "프런트 케이스의 누설"],
        answer: 3,
        explain: "프런트 케이스에는 오일펌프가 설치되어 있으며 조립 시 실런트(액상 개스킷)을 도포하는데 장시간 과열 등으로 불량 시엔 진오일이 누설될 수 있다."
    },
    {
        question: "전자제어 연료장치에서 기관이 정지된 후 연료압력이 급격히 저하되는 원인으로 옳은 것은?",
        options: ["연료의 리턴 파이프가 막혔을 때", "연료 필터가 막혔을 때", "연료펌프의 체크밸브가 불량할 때", "연료펌프의 릴리프밸브가 불량할 때"],
        answer: 2,
        explain: "체크밸브는 엔진 정지 후 연료의 잔압을 유지시키므로 만약 열린 상태에서 엔진이 정지되면 잔압이 없으므로 정지후 연료압력이 저하된다."
    },
    {
        question: "전자제어 점화장치에서 점화시기를 제어하는 순서는?",
        options: ["각종 센서 → ECU → 파워 트랜지스터 → 점화코일", "각종 센서 → ECU → 점화코일 파워 → 트랜지스터", "파워 트랜지스터 → 점화코일 → ECU → 각종 센서", "파워 트랜지스터 → ECU→ 각종 센서 → 점화 코일"],
        answer: 0,
        explain: "크랭크각 센서의 신호 및 각종 센서 신호가 ECU로 입력되면 ECU는 이를 연산하여 최적의 점화시기에 파워TR을 작동시켜 점화코일에서 고전압을 유기시킨다."
    },
    {
        question: "현가장치가 갖추어야 할 기능이 아닌 것은?",
        options: ["주행 안정성이 있어야 한다.", "승차감 향상을 위해 상하 움직임에 적당한 유연성이 있어야 한다.", "원심력이 발생되어야 한다.", "구동력 및 제동력 발생 시 적당한 강성이 있어야 한다."],
        answer: 2,
        explain: "원심력에 대한 저항이 있어야 한다."
    },
    {
        question: "기동 전동기의 종류에서 계자 코일과 전기자 코일이 직렬로 접속되어 있으며, 큰 회전력(torque)을 얻을 수 있으나 부하의 변화에 따라 회전속도의 변화가 큰 것은?",
        options: ["직권 전동기", "분권 전동기", "복권 전동기", "동기 전동기"],
        answer: 0,
        explain: "지문은 직권 전동기에 대한 설명이다."
    },
    {
        question: "유효반지름이 0.6m인 바퀴가 500rpm으로 회전할 때 차량의 속도(km/h) 는?",
        options: ["56", "95", "113", "123"],
        answer: 2,
        explain: "<a href='https://blog.naver.com/PostView.naver?blogId=ddsp0201&Redirect=View&logNo=223470915229&categoryNo=12&isAfterWrite=true&isMrblogPost=false&isHappyBeanLeverage=true&contentLength=3099' target='_blank'>문제 해설</a>"
    },
    {
        question: "종감속기어에 사용되는 하이포이드 기어의 구동 피니언은 일반적으로 링기어 지름 중 약 몇 % 정도 편심되어있는가?",
        options: ["5~10%", "10~20%", "20~30%", "30~40%"],
        answer: 1,
        explain: "하이포이드기어는 스파이럴 베벨 기어의 일종으로서, 종 감속기어로 이용되며 링기어의 회전 중심선과 이것에 맞물린 구동 피니언의 회전 중심선을 링기어 지름의 10~20% 정도 오프셋시켜 추진축이나 차실의 바닥을 낮출 수 있도록 한 것이다."
    },
    {
        question: "동력조향장치의 유압계통 점검사항으로 틀린 것은?",
        options: ["캠링과 프런트 사이드 플레이트의 긁힘", "펌프축과 풀리의 균열 또는 변형", "유량제어 밸브의 상태", "베인의 확실한 고정 상태"],
        answer: 3,
        explain: "동력조향장치의 유압펌프 타입으로 베인 펌프가 주로 사용된다. 로터에 삽입된 베인이 회전에 의한 원심력으로 바깥쪽으로 밀려 캠링에 밀착되어야 하므로 고정되면 안된다.\n※ 이 문제는 베인펌프의 구조 및 작동원리를 알아야 함"
    },
    {
        question: "냉각수 규정용량이 15L인 라디에이터에 냉각수를 주입하였더니 12L가 주입되어 가득찼다면 이 경우 라디에이터 코어 막힘률은?",
        options: ["20%", "25%", "30%", "45%"],
        answer: 0,
        explain: "<a href='https://blog.naver.com/PostView.naver?blogId=ddsp0201&Redirect=View&logNo=223470912215&categoryNo=12&isAfterWrite=true&isMrblogPost=false&isHappyBeanLeverage=true&contentLength=3099' target='_blank'>문제 해설</a>"
    },
    {
        question: "엔진 정비 작업 시 발전기 구동벨트를 발전기 풀리에 걸 때는 어떤 상태에서 거는 것이 좋은가?",
        options: ["엔진 정지 상태에서", "천천히 크랭킹 상태에서", "엔진 아이들 상태에서", "엔진을 서서히 가속하면서"],
        answer: 0,
        explain: "정비 기초로 대부분의 정비 시 엔진 정지상태에서 작업한다."
    },
    {
        question: "LPG 기관에서 LPG 최고 충전량은 봄베 체적의 약 몇 %인가?",
        options: ["70%", "75%", "85%", "90%"],
        answer: 2,
        explain: "법규상 봄베의 최고 충전량은 봄베 체적의 85%로 제한한다"
    },
    {
        question: "유압식 제동장치의 작동상태 점검 시 누유가 의심되는 경우 점검 위치로 틀린 것은?",
        options: ["모든 브레이크 파이프와 파이프의 연결상태", "마스터실린더 리저버 탱크 내에 설치된 리드 스위치", "브레이크 캘리퍼 또는 휠 실린더", "마스터 실린더의 브레이크 파이프 피팅부"],
        answer: 1,
        explain: "마스터 실린더 리저버 탱크에는 오일의 잔존량을 감지할 수 있도록 한 감지스위치(리드 스위치)가 있어 오일 부족 시 운전자에게 전기적 신호로 경고표시한다."
    },
    {
        question: "드라이브 샤프트(등속조인트) 고무부트 교환 시 필요한 공구가 아닌 것은?",
        options: ["육각 렌치", "스냅링플라이어", "부트 클립 플라이어", "(-) 드라이버"],
        answer: 0,
        explain: "고무부트 교환 시 필요 공구\n(-) 드라이버와 스냅링플라이어, 부트 클립 플라이어(부트 밴드 플라이어)\n※ 구조상 볼트로 조이는 부분이 없으므로 육각렌치는 사용할 필요가 없다. 실기에 관한 것으로 부트 클립 플라이어 대신 롱로즈 플라이어 등을 사용하기도 한다. 이 문제는 실기 내용까지 알아야 하므로 암기만 해둔다."
    },
    {
        question: "이모빌라이저 장치에서 엔진 시동 제어 장치가 아닌 것은?",
        options: ["충전장치", "시동장치", "점화장치", "연료장치"],
        answer: 0,
        explain: "이모빌라이저 장치 제어\n시동장치, 연료장치, 점화장치"
    },
    {
        question: "다음 그림의 전자제어 연료분사장치의 인젝터 파형이다. ᄀ~ᄅ의 설명으로 틀린 것은?",
        imagePath: "./CodeQuestion/maintenance2_kiwi.jpg",
        options: ["1", "2", "3", "4"],
        answer: 1,
        explain: "ㄴ은 인젝터를 구동시키기 위한 트랜지스터가 ON되는 지점이다."
    },
    {
        question: "자동차의 연료탱크 및 주입구, 가스 배출구에 대한 기준으로 틀린 것은? (단, 자동차 및 자동차부품의 성능과 기준에 관한 규칙에 의한다)",
        options: ["연료장치는 자동차의 움직임에 의하여 연료가 새지 아니하는 구조일 것", "배기관의 끝으로부터 30cm 이상 떨어져 있을 것(연료탱크를 제외함)", "차실 안에 설치하지 아니하여야 하며, 연료탱크는 차실과 벽 또는 보호판 등으로 격리되는 구조일 것", "노출된 전기단자 및 전기개폐기로부터 10cm 이상 떨어져 있을 것(연료탱크 를 제외함)"],
        answer: 3,
        explain: "노출된 전기단자 및 전기개폐기로부터 20cm 이상 떨어져 있을 것 (연료탱크를 제외함)"
    },
    {
        question: "기관에서 화재가 발생했을 때 조치방법으로 가장 적절한 것은?",
        options: ["점화원을 차단한 후 소화기를 사용한다.", "기관을 가속하여 냉각팬을 이용하여 끈다.", "물을 붓는다.", "자연적으로 모두 연소될 때까지 기다린다."],
        answer: 0,
        explain: "-"
    },
    {
    ...
    {
        question: "전원이동 불가 현상 발생으로 버튼 시동시스템을 진단장비로 점검 시 내용으로 틀린 것은?",
        options: ["시리얼 통신라인 체크", "실내 및 외부 안테나 구동 검사", "스마트키(FOB) 작동상태", "스타터 모터 상태 점검"],
        answer: 1,
        explain: "'전원 이동'이란 시동버튼을 누를 때 시동에 필요한 ESCL 록 해제 및 스타터 모터, 연료펌프, 점화장치에 전원을 인 가하는 것을 말한다. 이 때 필요한 요소는 FOB의 인증 정보, 스마트키 유닛, PDM(전원분배모듈), 시리얼 통신라인, 엔진 ECU 등과 관련이 있다.\n※ 실내외 안테나의 구동은 도어개폐 및 이모빌라이저 시스템에 필요하다."
    },
    {
        question: "실린더 헤드를 분리할 때 올바른 방법은?",
        options: ["바깥쪽에서 안쪽으로 향하여 대각선 방향으로 푼다.", "시계방향으로 차례대로 푼다.", "반드시 토크렌치를 사용한다.", "반시계방향으로 차례대로 푼다."],
        answer: 0,
        explain: "• 헤드 볼트 풀 때 : 바깥쪽 > 안쪽\n• 헤드 볼트 체결할 때 : 안쪽 > 바깥쪽"
    },
    {
        question: "바디전장시스템의 모듈에서 스위치를 감지하기 위한 5V 풀업(Pull-Up) 방식에 대한 설명으로 옳은 것은?",
        options: ["스위치 OFF 시 2.5 V이다.", "스위치 OFF 시 5V이다.", "스위치 ON 시 2.5 V이다.", "스위치 ON 시 5V이다."],
        answer: 1,
        explain: "<a href='https://blog.naver.com/PostView.naver?blogId=ddsp0201&Redirect=View&logNo=223470904354&categoryNo=12&isAfterWrite=true&isMrblogPost=false&isHappyBeanLeverage=true&contentLength=3099' target='_blank'>문제 해설</a>"
    },
    {
