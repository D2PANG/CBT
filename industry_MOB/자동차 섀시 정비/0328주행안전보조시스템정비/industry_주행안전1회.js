...
function shuffleArray(array) {
  ...
  function submitQuiz() {
    ...
    status.innerHTML = `<span id="scoreDisplay">주행안전보조시스템 정비 1회차 총점: ${score}/${questions.length}</span>`;
    ...
    resultDiv.innerHTML = `<h2>주행안전보조시스템 정비 1회차 총점: ${score}/${questions.length}</h2>`;
  }
