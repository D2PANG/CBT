...
function shuffleArray(array) {
  ...
  function submitQuiz() {
    ...
    status.innerHTML = `<span id="scoreDisplay">전자제어 현가장치 정비 1회차 총점: ${score}/${questions.length}</span>`;
    ...
    resultDiv.innerHTML = `<h2>전자제어 현가장치 정비 1회차 총점: ${score}/${questions.length}</h2>`;
  }
