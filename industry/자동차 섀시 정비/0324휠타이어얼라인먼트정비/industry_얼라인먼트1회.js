...
function shuffleArray(array) {
  ...
  function submitQuiz() {
    ...
    status.innerHTML = `<span id="scoreDisplay">휠·타이어·얼라인먼트 정비 1회차 총점: ${score}/${questions.length}</span>`;
    ...
    resultDiv.innerHTML = `<h2>휠·타이어·얼라인먼트 정비 1회차 총점: ${score}/${questions.length}</h2>`;
  }
