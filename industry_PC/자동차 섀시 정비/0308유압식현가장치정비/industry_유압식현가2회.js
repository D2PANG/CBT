...
function shuffleArray(array) {
  ...
  function submitQuiz() {
    ...
    status.innerHTML = `<span id="scoreDisplay">유압식 현가장치 정비 2회차 총점: ${score}/${questions.length}</span>`;
    ...
    resultDiv.innerHTML = `<h2>유압식 현가장치 정비 2회차 총점: ${score}/${questions.length}</h2>`;
  }
